 ...
 */
final class Version20260103172235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE slider (id INT AUTO_INCREMENT NOT NULL, image_name VARCHAR(255) NOT NULL, title VARCHAR(255) NOT NULL, is_active TINYINT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
