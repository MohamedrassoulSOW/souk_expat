 ...
 */
final class Version20260101212243 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE annonce_image (id INT AUTO_INCREMENT NOT NULL, imade_name VARCHAR(255) NOT NULL, annonce_id INT NOT NULL, INDEX IDX_D2B0CFC08805AB2F (annonce_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
