...
/**
 * Convertit les tables MyISAM → InnoDB et ajoute les clés étrangères manquantes.
 * Sans InnoDB, Doctrine ne peut pas créer les FK (schema:validate échoue).
 */
final class Version20260813120000 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Convert MyISAM tables to InnoDB and add foreign keys';
    }
